...
class UserRegistrationService{
    ...
    private func instansiateFirebaseUser(name: String, displayName: String, path: String){
        let user: FirebaseUser = FirebaseUser(id: authCurrentUser().uid, name: name, displayName: displayName, email: authCurrentUser().email!, date: Date(), profilePictureURL: path, following: nil, feedItems: nil)
